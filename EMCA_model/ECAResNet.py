...
class ECAResNet(nn.Module):
    def __init__(self, block, layers, in_channel=2, modality = 2, device = 'cpu'):
        ...
        self.conv1 = nn.Conv2d(in_channel, self.firstplanes, kernel_size=3, stride=1, padding=1, groups=self.modality, bias=False)
...
#     """
#     model = ResNet(ECABasicBlock, [2], **kwargs)
#     return model
#
